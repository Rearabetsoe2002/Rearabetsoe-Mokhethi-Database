      ...
      <section style={{ marginTop: '20px' }}>
        ...
        {products.length === 0 ? (
          ...
          <div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '15px', color: 'white' }}>
              <thead>
                <tr>
                  <th style={{ border: '1px solid #ddd', padding: '8px', background: '#f4f4f4', color: 'black' }}>Name</th>
                  <th style={{ border: '1px solid #ddd', padding: '8px', background: '#f4f4f4', color: 'black' }}>Description</th>
                  <th style={{ border: '1px solid #ddd', padding: '8px', background: '#f4f4f4', color: 'black' }}>Price</th>
                  <th style={{ border: '1px solid #ddd', padding: '8px', background: '#f4f4f4', color: 'black' }}>Quantity</th>
                </tr>
              </thead>
              <tbody>
